...
-- Add Student
insert into login values("vishal99", "vishal123", "user");
insert into lib_users values("vishal99", "Vishal Gangwar", "tilak nagar", "student", '1999-09-06');

-- Add faculty
insert into login values("sejal90", "sejal123", "user");
